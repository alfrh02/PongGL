...
void drawBitmapString(Shader& shader, std::string string, glm::vec2 position, glm::vec4 color = glm::vec4(1.0f), glm::vec2 scale = glm::vec2(16.0f), float rotation = 0.0f, bool centred = true);
